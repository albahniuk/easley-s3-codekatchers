                ...
                <div className="design--colours_radio">
                    <div className="clase__green">
                        <label className="clase" htmlFor="green">
                            <input onChange={this.handleColorCheck} className="design_input" type="radio" name="colors" value="green" id="green" checked={this.state.check === 'green'} />
                    ...
                    <div className="clase clase__red">
                        <input onChange={this.handleColorCheck} className="design_input" type="radio" name="colors" value="red" id="red" checked={this.state.check === 'red'} />
                        <label htmlFor="red">
                            <div className="design--colours_label">
                    ...
                    <div className="clase clase__blue">
                        <input onChange={this.handleColorCheck} className="design_input" type="radio" name="colors" value="blue" id="blue" checked={this.state.check === 'blue'} />
                        <label htmlFor="blue">
                            <div className="design--colours_label">
