    ...
    render() {
        return (
            <form className="form" method="post">
                ...
                <Design collapsibleDesign={this.props.collapsibleDesign} handleColor={this.props.handleColor} handleFonts={this.props.handleFonts} handleCollapsibleDesign={this.props.handleCollapsibleDesign} arrowDesign={this.props.arrowDesign}/>
